...
public class ClosestSumProblem {
    public static void main(String[] args) {
        // NOTE: You can use the following input values to test this function.
        int[] a1 = {-1, 3, 8, 2, 9, 5};
        int[] a2 = {4, 1, 2, 10, 5, 20};
        int aTarget = 24;
        System.out.print(closestSumPair(a1, a2, aTarget)[0]); //should return {5, 20} or {3, 20}
        System.out.print(closestSumPair(a1, a2, aTarget)[1]); //should return {5, 20} or {3, 20}
